...
export default function CarousalControl({title,subtitle,buttontext,controlsflexDirection,controlsjustifyContent,subtitleboldFlag,carousalButtonsControlFlag}) {
